...
Functions:
    ...
    modifiedSortGPA: sorts the arrays contents based on the lowest to highest GPA
...
int main()
{
    ...
    while (choice != 3)
    {
        ...
        {
            int ID = 0, index = -1, linearNIter = 0, binaryNIter = 0;
            cout << "Enter netID: ";
            cin >> ID;
...
{
    int index = 0, first = 0, last = numElems - 1, middle = 0, position = -1;
    bool found = false;
